...
namespace Winterdom.BizTalk.Samples.FixEncoding
{
   ...
   /// <summary>
   /// Fixes the encoding of incoming XML messages
   /// where the XmlDisassembler can't figure out the encoding
   /// of the message on its own, by allowing you to create a 
   /// custom pipeline that forces the message to be processed
   /// in a given encoding.
   /// </summary>
   [ComponentCategory(CategoryTypes.CATID_PipelineComponent)]
   [System.Runtime.InteropServices.Guid("3ce651a3-9c9c-4cfd-96c2-5fee7cdc9455")]
   [ComponentCategory(CategoryTypes.CATID_Decoder)]
   public class FixEncodingComponent : 
      ...
      IBaseComponent, IPersistPropertyBag, IComponentUI
   {
      ...
      private ResourceManager _resourceManager =
         new ResourceManager("Winterdom.BizTalk.Samples.FixEncoding.FixEncodingComponent", 
      ...
      public FixEncodingComponent()
      {
         _encoding = global::System.Text.Encoding.UTF8;
      }

      static FixEncodingComponent()
      {
      ...
      {
         inmsg.BodyPart.Charset = _encodingList[Encoding.CodePage];
         return inmsg;
      }
      #endregion

   } // class FixEncodingComponent
